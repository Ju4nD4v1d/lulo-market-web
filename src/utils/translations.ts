...
export const translations: Translations = {
  en: {
    ...
    'contact.successNote': 'Click the "Schedule 15 min demo" button that will appear to book your consultation call',
  ...
  es: {
    ...
    'contact.successNote': 'Haz clic en el botón "Agendar demo de 15 min" que aparecerá para reservar tu llamada de consulta',
